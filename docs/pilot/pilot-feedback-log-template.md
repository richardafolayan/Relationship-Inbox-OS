...
> Copy everything between the lines for each tester.
...
**Platform(s) used:** (LinkedIn / iMessage / other)
...
**Where the action items missed something:**

**Where the AI felt like too much:**
...
<!-- Paste filled-in entries below this line. -->
