...
Baseline commit: `1c23f2c40a3894a721e278d085fc4b23b76c02e1`
Measured implementation commit: `cad95d3a9ca2a0db87d59accc04087f4c29dd409`
...
| --- | ---: | ---: | --- |
| Tracked repository source | 9,470,701 | 797 | Every regular file in the baseline tree, before dependencies or builds |
...
| Final macOS app bundle | 2,054,802,301 | 38,337 | Complete `Relationship Inbox OS.app` |
| DMG | 983,752,998 | 1 | Complete UDZO disk image |
| Packaged application resources | 1,787,421,068 | 38,081 | `Contents/Resources`, including app payload and bundled Node |
| Packaged dependencies | 1,441,296,137 | 32,165 | Packaged `node_modules` after Prisma generation and all builds |
| Bundled Node runtime | 184,863,435 | 4,750 | Complete official Node 22 distribution copied into the app |
| Generated Next build | 149,071,058 | 194 | Entire packaged `.next` directory |
| Generated Next build cache | 144,798,365 | 9 | Build cache, 97.13% of the generated Next build |
| Generated runner build | 2,097,796 | 136 | `apps/runner/dist` |
| Generated core build | 64,418 | 36 | `packages/core/dist` |
| Generated Prisma client | 22,768,623 | 18 | `node_modules/.prisma`, also counted inside packaged dependencies |
...
| Packaged tests | 1,538,406 | 354 | Test sources copied by `git archive` |
...
| macOS app bundle | 2,054,802,301 | 1,272,598,388 | 782,203,913 | 38.07% |
| DMG | 983,752,998 | 662,424,881 | 321,328,117 | 32.66% |
| Packaged application resources | 1,787,421,068 | 1,005,217,155 | 782,203,913 | 43.76% |
| Packaged dependencies | 1,441,296,137 | 864,260,885 | 577,035,252 | 40.04% |
| Bundled Node runtime | 184,863,435 | 129,613,755 | 55,249,680 | 29.89% |
| Generated Next build | 149,071,058 | 4,320,151 | 144,750,907 | 97.10% |
| Generated Next build cache | 144,798,365 | 0 | 144,798,365 | 100.00% |
| Source maps | 172,579,454 | 149,609,878 | 22,969,576 | 13.31% |
| Packaged tests | 1,538,406 | 0 | 1,538,406 | 100.00% |
| Packaged design-review screenshots | 3,257,549 | 0 | 3,257,549 | 100.00% |

The runner build (2,097,796 bytes), core build (64,418 bytes), Prisma client (22,768,761 bytes), documentation (379,807 bytes), runtime app icon (175,893 bytes), npm CLI and Patchright runtime remain packaged. Source maps were not removed wholesale; their reduction is only the consequence of removing unused modules.
...
| Next build cache | 144,798,365 packaged | Nine build-only files; no runtime request reads this directory. | Safe to omit from the packaged app after the build completes. |
...
| Updater recovery backups | 0 | Default maximum is two prior installs. At the baseline app size, two same-size backups would be 4,109,604,602 logical bytes. | Keep two by default for rollback. `--keep-backups` is explicit; never delete the only recoverable copy during a failed update. |
...
- Full regression suite: core and runner compilation plus 1,459 tests passed.
