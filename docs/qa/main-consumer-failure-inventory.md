...
| Runner offline | “Tovi is reconnecting” and Start runner | Network failure with path and phase | Yes for starting or reconnecting | Start runner, then reopen the app if needed | No data-loss claim is made; sending is paused |
