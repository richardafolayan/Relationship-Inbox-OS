...
// unbroken URL (Airbnb links in real pilot data) widened the column and put
// a horizontal scrollbar under the chat that dragged the sticky header along.
// Two layers: bubbles break long tokens, and the scroller clips the x axis.
