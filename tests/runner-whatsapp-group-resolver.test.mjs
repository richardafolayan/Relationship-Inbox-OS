...
test("chatToThreadStub maps a group chat to a group ThreadStub with groupName / groupId set", () => {
  const stub = chatToThreadStub({
  ...
  assert.equal(stub.groupId, "12345-67890@g.us");
  assert.equal(stub.handle, "12345-67890@g.us");
